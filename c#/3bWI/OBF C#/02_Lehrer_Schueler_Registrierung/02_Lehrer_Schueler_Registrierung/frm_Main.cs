...
namespace _02_Lehrer_Schueler_Registrierung
{
    public partial class frm_Main : Form
    {
            ...
            else
            {
                ...
                try
                {
                    ...
                    {                                               //Dateiname
                        ...
                        CPerson My_Person = new CPerson(cb_Schulpartner.Text, tb_Vorname.Text, tb_Nachname.Text, iJahr, tb_Wohnort.Text, tb_Strasse.Text, tb_Hausnummer.Text);
        ...
        private void btn_DatensaetzeAnzeigen_Click(object sender, EventArgs e)
        {
            ...
            frm_Ausgabe My_frmAusgabe = new frm_Ausgabe(this);//Erzeugendes Formular frm_Ausgabe
